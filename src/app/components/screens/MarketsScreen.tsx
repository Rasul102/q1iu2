  ...
  return (
    <div className="h-full overflow-y-auto px-4 pb-28 pt-5 bg-[#112D4E]">
      <div className="mb-4 relative flex items-center justify-center">
        <div>
          <div className="text-[#F6F0D7] text-xl font-semibold">Quickie</div>
        </div>
      ...
      <div className="rounded-3xl bg-black/10 backdrop-blur-2xl p-5 shadow-[0_12px_40px_rgba(0,0,0,0.35)]">
        <div className="absolute right-0 flex items-center gap-2">
